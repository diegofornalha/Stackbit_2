...
export default function HeroSection(props) {
    const { type, elementId, colors, backgroundSize, title, subtitle, subtitle2, text, media, actions = [], styles = {}, 'data-sb-field-path': fieldPath } = props;
        ...
        <Section type={type} elementId={elementId} colors={colors} backgroundSize={backgroundSize} styles={styles.self} data-sb-field-path={fieldPath}>
            ...
            >
                <div className="flex-1 w-full">
                    <HeroBody title={title} subtitle={subtitle} subtitle2={subtitle2} text={text} styles={styles} />
        ...
        <>
            ...
            {subtitle && (
                ...
                >
                    ...
                    <span className={classNames('inline-block', 'primary')}><Typewriter
                        options={{
